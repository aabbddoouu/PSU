...
uint8_t Screen_ADDR=SSD1306_I2C_ADDR;
...
void ssd1306_WriteCommand(uint8_t byte) {
   //command=0x00 (control byte) : Co=0 D/C=0 + 6 '0's
   i2c_xfer7(I2C_OLED, Screen_ADDR, 0x00, &byte, 1U, AUTOEND);
}

// Send data
void ssd1306_WriteData(uint8_t* buffer, size_t buff_size) {
    //command=0x40 (control byte) : Co=0 D/C=1 + 6 '0's
    i2c_xfer7(I2C_OLED, Screen_ADDR, 0x40, buffer, buff_size, AUTOEND);
